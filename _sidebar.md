...
- Инструкции по установке агентов
  ...
  - [Инструкции по установке агентов 1C](1C/contents.md)
    - [Агент для ЖР](1C/rj_agent.md)
    - [Агент для ТЖ](1C/tj_agent.md)
    - [Агент для кластера 1С](1C/1C_cluster_agent.md)
    - [Агент для MSSQL](1C/MSSQL_agent.md)
    - [Инфраструктурный агент для Windows сервера](1C/win_server_infra_agent.md)
- Модули GMONIT
  - [APM](modules/APM.md)
  - Карта сервисов
  ...
  - [Таблица активных оповещений](modules/alert-pack/alert-table-labels.md)
  - [Инфраструктурный мониторинг](modules/infra.md)
  - [Kubernetes](modules/kubernetes.md)
    - [Настройка](modules/kubernetes/setup.md)
    - [Использование](modules/kubernetes/guide.md)
  - [Синтетический мониторинг](modules/synthetics.md)
    - [Настройка](modules/synthetics/setup.md)
    - [Использование](modules/synthetics/guide.md)
    - [Доступность веб-сервисов](modules/infra/urlcheck.md)
  - [SLO](modules/slo.md)
    - [Использование](modules/slo/guide.md)
  - [Бизнес-мониторинг](modules/business-monitoring.md)
    - [Настройка](modules/business-monitoring/setup.md)
    - [Использование](modules/business-monitoring/guide.md)
