...
Для запуска GMONIT в `docker` необходима версия __Docker 29.1.4*__ и установленный актуальный [__плагин Compose для Docker__](https://docs.docker.com/compose/install/linux/).
