...
* `APP_DEPENDENCIES_TTL_DAY` (366) — хранение данных о зависимостях приложений;
...
* `ERROR_EVENT_DATA_TTL_DAY` (30) — хранение событий об ошибках, по которым строятся графики и выборки;
...
* `BROWSER_INSIGHTS_TTL_DAY` (2) — хранение пользовательских действий на странице;
* `BROWSER_JSERRORS_TTL_DAY` (8) — хранение информации об ошибках JavaScript в браузере;
* `BROWSER_LOGS_TTL_DAY` (1) — хранение логов браузера;
...
* `INCIDENTS_TTL_DAY` (30) — хранение инцидентов и результатов их анализа;
* `SEGMENT_STATS_DAYS` (3) — хранение статистики группировки URL.
