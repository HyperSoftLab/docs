...
* `BROWSER_TIMING_EVENTS_TTL_DAY` (не указан) — хранение браузерных timing-событий;
...
* `ONE_C_TECH_LOG_EVENTS_TTL_DAY` (30, не подтверждён) — хранение событий технологического журнала 1С.
