...
- Добавлена новая карта сервисов. Новые отображения: 
  - Внешние (External) HTTP взаимодействия
  - Обращения к базам данных (Datastore)
  - Apdex
  - RPM на связях между сервисами.
  Доступна на экране приложений во вкладке Service map v2.

- Новый движок распределенной трассировки: 
  - Добавлена поддержка браузерных и мобильных взаимодействий

- В браузерный мониторинг добавлена система автоматической группировки URL-адресов страниц, основанная на анализе статистики посещений.
  
- Добавлена метрика INP, оценивающая скорость реакции сайта на пользовательские взаимодействия, для браузерных приложений. 
  Новый дашборд для нее доступен во вкладке Browser. 
