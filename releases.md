...
- **`v4-4514`** 🚀 Новая схема хранения инфраструктурных метрик! Занимает в 10 раз меньше места: 130 млн записей = ~1 ГБ (было 12 млн).Запросы стали ощутимо быстрее. Как использовать:
...
### 🚀 GMonit v4: поддержка новых версий ClickHouse и Redis
