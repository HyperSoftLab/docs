...
- **`v4-6728`** 🔜 Добавлены правила переименования транзакций. Теперь можно задать на уровне приложения, как сворачивать имена транзакций — полезно для приложений с динамическими URL в имени.
