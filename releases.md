...
- **`v3-4147`** 🔧 Исправлено отображение метрик контейнеров на главной странице.
- **`v3-4145`** 🆕 Домашняя страница и дашборды APM теперь доступны на русском языке! Будем признательны за ваши предложения по улучшению перевода.
