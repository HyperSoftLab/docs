...
- **`v4-4514`** 🚀 Новая схема хранения инфраструктурных метрик!
  Занимает **в 10 раз меньше места**: 130 млн записей = ~1 ГБ (было 12 млн). Запросы стали ощутимо быстрее. Такая оптимизация стала возможна переходу на `v4` и обновлению ClickHouse. Как обновиться и использовать:
