...
### Март 2026
- **`v4-6560`** 🆕 Добавлена кнопка копирования SLO. Теперь можно создать новый SLO на основе существующего.
- **`v4-6559`** ✨ На панелях SLO с дополнительными запросами отображается информационное сообщение.
- **`v4-6558`** ✨ Домашняя страница GMonit теперь учитывает выбранную домашнюю страницу в настройках профиля Grafana.
- **`v4-6554`** 🔧 Исправлены панели сессий и лицензий 1С — вместо абсолютных значений используется корректная метрика (rpm).
- **`v4-6553`** 🆕 На страницу баз данных 1С добавлены панели блокировок, таймаутов и дедлоков СУБД.
- **`v4-6550`** 🔧 На странице ошибок ссылки на трейсы отображаются только если трейс существует.
- **`v4-6548`** 🔧 Исправлены пустые ссылки в таблицах ошибок 1С.
- **`v4-6547`** 🔧 Исправлена проблема, при которой панели пользовательских дашбордов игнорировали настройку minInterval.
- **`v4-6539`** 🔧 Исправлена навигация из панели отчётов транзакций — ссылка на детали отчёта вела на неверную страницу.
- **`v4-6533`** 🔧 Исправлен шаблон алертов в форме настройки оповещений.
