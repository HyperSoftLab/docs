...
- **`v3-3919`** ✨ Улучшения отображения трейсов OpenTelemetry.
- **`v3-3906`** 🆕 На все timeseries графики APM мониторинга добавлены аннотации времени старта приложения, для большего контекста при выявлении причин аномалий.
