...
### Октябрь 2025
* **`v4-5280`** В новый UI GMONIT добавлена поддержка отображения данных legacy инфраструктурного мониторинга (которая использовалась до `v5-4514` и изменена начиная с этой версии)
