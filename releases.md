...
1. обновите тэг GMonit Collector и Grafana до `v4-xxxx`
...
- **`v3-3943`** 🔧 Исправлена ошибка RUM-инструменации Grafana при рестарте сервиса GMonit Grafana. Это обновление рекомендовано, если у вас установлена переменная `GMONIT_GRAFANA_BROWSER_AGENT__URL`.
