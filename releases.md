...
- **`v3-4000`** 🆕 На домашнюю страницу добавлены два новых ряда: сводный показатель здоровья системы за день с динамикой по сравнению со вчерашним днём и недельный график. ТТеперь структура экрана выстроена по принципу — от общего состояния к деталям и причинам отклонений.
