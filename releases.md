...
### Октябрь 2025
* **`v4-5282`** 🔧 В новый UI GMONIT добавлена поддержка отображения данных legacy инфраструктурного мониторинга (которая использовалась до `v5-4514` и изменена начиная с этой версии)
...
* **`v4-5180`** 🔧 Исправлена обработка данных автоинструментированного браузерного мониторинга по части группировки URL страниц.
