...
* Переменная окружения `BROWSER_MONTINORING_ENABLED` больше **не поддерживается**. Используйте корректное название: `BROWSER_MONITORING_ENABLED`.

Если при обновлении на v4 версии зависимостей не соответствуют требованиям — коллектор не запустится и выдаст соответствующую ошибку.
