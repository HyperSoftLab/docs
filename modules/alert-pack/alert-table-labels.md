...
Здесь одно правило раскладывается на инстансы по приложениям (`app_name`), а профиль важности задан константой `'P2'` — одинаковый для всех. Раз он не зависит от строки, его можно было бы задать и первым способом — статическим лейблом на правиле, а не столбцом в запросе.
