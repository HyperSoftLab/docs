...
Также при необходимости можно указать путь и параметры подключения к базе данных уязвимостей (`DVS_DATA_DIRECTORY`, `DVS_DB_FILE_NAME`, `DVS_DB_USER`, `DVS_DB_PASSWORD`).
